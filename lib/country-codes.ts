...
// This maps the API's 2-letter codes (ISO 3166-1 alpha-2)
// to the Map's 3-letter codes (ISO 3166-1 alpha-3)
export const ISO_MAP: Record<string, string> = {
  ...
  DE: "DEU", DJ: "DJI",pK: "DNK", DM: "DMA", DO: "DOM", DZ: "DZA",
  ...
  TC: "TCA", TD: "TCD", TF: "ATF", TG: "TGO", TH: "THA", TJ: "TJK", TK: "TKL", TL: "TLS", TM: "TKM", TN: "TUN", TO: "TON", TR: "TUR", TT: "TTO", TV: "TUV", TW: "TWN",TZ: "TZN",
